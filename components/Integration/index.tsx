      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `TECHNOLOGIES`,
              subtitle: `We Use Cutting-Edge Technologies`,
              description: `We pride ourselves on using the latest technologies to ensure top-notch project quality. From development to deployment, we stay ahead,
               delivering solutions that not only meet but exceed expectations. Choose innovation; choose superior quality with us.`,
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/tailwind-css.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/spring-boot.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
