        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <a href="index.html" className="relative">
                  ...
                  <Image
                    width={110}
                    height={80}
                    src="/images/logo/logo2-light.png"
                    alt="Logo"
                ...
                Best quality is not a compromise, but a commitment to excellence in every aspect of our business.
                </p>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-5/12">
                {/* <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} GENZ Technologies (Pvt) Ltd. All rights reserved
              </p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://www.facebook.com/genztechno" aria-label="social icon">
                    <svg
                ...
                <li>
                  <a href="https://x.com/genztech_" aria-label="social icon">
                ...
                <li>
                  <a href="https://www.linkedin.com/company/genztechnologies" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
